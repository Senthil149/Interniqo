      ...
      <div className="rounded-2xl border border-slate-200 bg-white p-6 sm:p-8 shadow-sm">
        {success ? (
          ...
          <form className="space-y-4" onSubmit={handleSubmit}>
            ...
            <div>
              <label htmlFor="reset-code-field" className="block text-center text-xs font-semibold uppercase tracking-wider text-slate-500 mb-1.5">
                6-Digit Reset Code
              </label>
              <input
                id="reset-code-field"
            ...
            <div className="pt-2 text-center">
              <Link to="/forgot-password" className="text-xs font-semibold text-indigo-600 hover:text-indigo-700 underline">
